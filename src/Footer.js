...
export const Footer = () => <div className="flex app-footer">
    ...
    <div className="flex row allwidth">
        ...
        <div className="flex allheight justifystart">
            ...
            <div className='flex flexdot6'>
                ...
                <div className='flex secondary'>
                    <div className='flex flexdot3 clickable hoverscale'>Professionnelle</div>
                    <div className='flex flexdot3 clickable hoverscale'>Testeur</div>
                    <div className='flex flexdot3 clickable hoverscale'>Client</div>
                </div>
            </div>
        </div>
